...
model_name = 'bnfuse_eld_small_mobilenets2_trained_weights_final.h5'
...
class YOLO(object):
    ...
    def detect_only(self, image , search ):
        start = timer()
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            #else :
            #    posx = "center"
            if search == predicted_class :
                #print(search , predicted_class)
                ntop, nleft, nbottom, nright = nearest_box
                nwi = (nright-nleft)
                nhe =  (nbottom-ntop)
                if (wi*he) > (nwi*nhe) :
                    nearest_box = top , left , bottom , right
                    nearest_label = label

            #print( '{} x,y(cent):{} , {} | x,y(top):{} , {} | x,y(bottom):{} , {} |w,h:{} , {}'.format(label, xc , yc , left, top,right, bottom , wi  , he  ) )
            ...
            draw.ellipse((xc, yc, xc+5, yc+5), fill = 'blue', outline ='blue')
        ...
        print(end - start)
        return image , nearest_box , nearest_label

    def detect_only_robot(self, image , search ):
        start = timer()
...
def detect_video(yolo, video_path, output_path=""):
    ...
    while True:
        ...
        image , box , label  = yolo.detect_only(image , "shoes")
